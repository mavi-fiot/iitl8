...
import com.example.metrics.MetricsConfiguration;
...
public class InitialState extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {
        if (update.hasMessage() && update.getMessage().hasText()) {
            MetricsConfiguration.messagesReceived.inc(); // Increment the counter
    ...
    public String getBotUsername() {
        return "obminvaliutfast_bot";
    }

    @Override
    public String getBotToken() {
        return "7295710933:AAHB0GpsmRddE3S7LCnQv2OCgudFBBfvBBU";
    }
